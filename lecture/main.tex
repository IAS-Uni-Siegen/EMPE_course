...
%% Power Electronics %%
\include{tex/Lecture08} % Power electronics
\include{tex/Lecture09} % Power semiconductor devices  
\include{tex/Lecture10} % Power electronic converters
\include{tex/Lecture11} % DC-DC converters
\include{tex/Lecture12} % DC-AC converters
\include{tex/Lecture13} % AC-DC converters
