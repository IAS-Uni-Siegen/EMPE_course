\section{Fundamentals- electrical, electromagnetic principles and magnetic materials}
\title[Fundamentals]{Fundamental of Electrical Engineering (relevant topics)}  
...
\begin{frame}
\begin{center}
  \textbf{\Huge{Basic Electrical Concepts}}
\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
          \begin{itemize}
            \item A phasor is a complex number representing a \textbf{sinusoidal} function.
            \item Sinusoid:
            \[ v(t) = V_m \cos(\omega t + \phi) \rightarrow \vec{V} = V_m e^{j\phi} \rightarrow V_m\angle \phi \]
            where, $V_m$ is the peak amplitude, $\omega$ = 2$\pi$\textit{ft}, the phase in radians, \textit{t} is seconds, and \textit{f} is the frequency in cycles per second, and $\phi$ is the phase angle (angular difference or shift between the voltage and current waveforms in an AC circuit). 
            \item Simplifies AC analysis using algebra.
          \end{itemize}
		\end{column}
        \hfill
		\begin{column}{0.4\textwidth}
          \begin{itemize}
            \item Addition/Subtraction: Vector addition.
            \item Multiplication/Division: Magnitudes multiply/divide, angles add/subtract.
            \item Example:
            \[ \vec{V_1} = 10\angle30^\circ, \quad \vec{V_2} = 5\angle-10^\circ \]
            \[ \vec{V_1} + \vec{V_2} = ? \quad \]
            (\text{Hint: convert to rectangular form}) 
          \end{itemize}
		\end{column}
		\end{columns}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Single-phase and three-phase systems}
	\begin{columns}
		\begin{column}{0.5\textwidth}
         \begin{itemize}
            \item \textbf{Single Phase}
            \item Consists of one alternating voltage source.
            \item Voltage expressed as:
            \[ v(t) = V_m \cos(\omega t + \phi) \]
            \item Used in residential and light commercial loads.
          \end{itemize}
			\begin{figure}
				\centering
				\includegraphics[scale=1.25]{fig/lec02/single_phase.pdf}
				\caption{Illustration of a single phase waveform}
			\end{figure}
		\end{column}
        \hfill
		\begin{column}{0.5\textwidth}
          \begin{itemize}
            ...
            \item Composed of three sinusoidal voltages of equal magnitude and frequency, \textbf{120$^\circ$} apart.
            \item Line voltages: \vspace{-0.3cm}
            \[ \begin{aligned}
              v_a(t) &= V_m \cos(\omega t) \\
              v_b(t) &= V_m \cos(\omega t - 120^\circ) \\
              v_c(t) &= V_m \cos(\omega t + 120^\circ)
            \end{aligned} \] \vspace{-0.5cm}
            %\item More efficient for power transmission.
          \end{itemize} \vspace{-0.5cm}
			\begin{figure}
				\centering
				\includegraphics[scale=0.05]{fig/lec02/3_phase_AC_waveform.svg}
				\caption{Illustration of a three phase waveform (source: \href{https://commons.wikimedia.org/wiki/File:3_phase_AC_waveform.svg}{Wikimedia Commons}, J JMesserly, \href{https://creativecommons.org/licenses/by-sa/3.0/deed.en}{CC BY 3.0})}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Star/Wye Connected Circuits %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Star/Wye Connection Basics}
			\begin{figure}
				\centering
				\includegraphics[scale=0.1]{fig/lec02/Wye-delta-2.svg}
				\caption{$\Delta$ and Y circuits (source: \href{https://en.wikipedia.org/wiki/Y-Δ_transform/media/File:Wye-delta-2.svg}{Wikimedia Commons}, \href{https://creativecommons.org/licenses/by-sa/3.0/}{CC BY-SA 3.0})}
			\end{figure}
\end{frame}
	...
	\begin{columns}
		\begin{column}{0.475\textwidth}
           ...
           \item \textbf{Star (Y) connection}
            \item Each phase connected to a common neutral point.
            \item Line and phase voltages:
            \[ V_L = \sqrt{3} V_{ph}, \quad \angle 30^\circ \] \\
            where $V_L$ is the line voltage and $V_{ph}$ is the phase voltage.
            \item Line and phase currents: $I_L$ = $I_{ph}$
		...
		\begin{column}{0.5\textwidth}
          \begin{itemize}            
           \itemsep0em
           \item \textbf{$\Delta$ connection}
            \item Line and phase voltages: $V_L$ = $V_{ph}$
            \item Line and phase currents:
            \[ I_L = \sqrt{3} I_{ph}, \quad \angle 30^\circ \]
            where $I_L$ is the line current and $I_{ph}$ is the phase current.
            \item \textbf{Power} in both configurations (balanced load):
            \[ P = \sqrt{3} V_L I_L \cos\phi \]
            where $\phi$ is the angle between voltage and current and $P$ is the active power.
            \item Both configurations deliver the same power if balanced and same load impedance.
          \end{itemize}
		\end{column}
		\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
          \begin{itemize}
            \item Active (Real) Power:
            \[ P = VI \cos\phi \quad (\text{Watts}) \]
            \item Reactive Power:
		...
		\begin{column}{0.5\textwidth}
          \begin{itemize}
            ...
            \item Graphical representation using a power triangle.
			\begin{figure}
				\centering
				\includegraphics[scale=0.25]{fig/lec02/Cmplxpower.png}
...
\begin{frame}
\begin{center}
  \textbf{\Huge{Basic Magnetic Concepts}}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
