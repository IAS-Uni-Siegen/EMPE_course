...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
          ...
          \begin{itemize}
            \item The wires in power systems have resistance $\rightarrow I^2R$/Joule losses eminent
            \item Ohm's law (V=IR), increase "V" reduce "I" for same power.  
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Elementary introduction of transformer %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{frame}{Current transformation}
...
\begin{frame}{Overview}
	...
	% Slide 2 - Steady State
	\begin{frame}{Steady-State and Dynamic (time domain) Modelling}
		\begin{columns}
...
\begin{frame}{Electromagnetic and Equivalent Circuit Modeling}
    \begin{columns}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Thermal and Mechanical Modeling}
    \begin{columns}
        \begin{column}{0.5\textwidth}
...
\begin{frame}{Data-Driven and Hybrid Modeling}
    \begin{columns}
        \begin{column}{0.5\textwidth}
