...
The course will be in two parts with 3 modules each.
		\begin{enumerate}
		  \item Electrical Machines
            \begin{itemize}
            	\item<1-> Module 1: Fundamentals
            	\item<2-> Module 2: Transformers
            	\item<3-> Module 3: Rotating machines
            \end{itemize}
		  \item Power Electronics
            \begin{itemize}
            	\item<1-> Module 1: Fundamentals
            	\item<2-> Module 2: Power converter topologies
            	\item<3-> Module 3: Introduction to electrical drives
            \end{itemize}
		\end{enumerate}
\textbf{Pattern of class}: \\ Day: Thursday, every week \\ Time: 8 am to 10 am (theory) and 10 am to 12 pm (tutorial) (ideally but it can change) \\ Holidays: 1st May, 29 May, and 19 June 2025. As required classes will be rescheduled. 
\end{frame}
...
\centering
		...
		\begin{figure}
			\centering
				\includegraphics[height=2.5cm]{fig/lec01/elter_1.jpg}
				\caption*{Silas Florian Elter}
		\end{figure}

		\column[T]{0.33\textwidth}
		\begin{figure}
			\centering
				\includegraphics[height=2.5cm]{fig/lec01/Wallscheid.jpg}
	...
	\begin{varblock}{Contact}
		...
		\end{itemize}
	\end{varblock}
** \small{The content of the slides for this course is based on \href{https://www.eti.uni-siegen.de/ias/teaching/}{43IAS6000V} and \href{https://www.eti.uni-siegen.de/ias/teaching/}{43IAS1101V}, prepared and delivered in past by Prof. Dr.-Ing Oliver Wallscheid.}
...
\begin{frame}
\center
\textbf{\huge{Part I: Electrical Machines}}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Understand the basics of electrical and magnetics to build foundation of electrical machines. 
		\item Understand the generation of magnetic fields, force formation and voltage induction in electrical machines.
		\item<2-> Differentiate the main types of electrical machines:
		\begin{itemize}
			\item DC machines. 
		...
		\item<4-> Basic analysis on the operation of electrical machines
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item PC Sen, Principles of Electric Machines and Power Electronics, International Adaptation. John Wiley \& Sons, 2021.
	\end{itemize}
\end{frame} 