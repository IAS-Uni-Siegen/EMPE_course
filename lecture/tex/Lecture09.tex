...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
    \frametitle{Output voltage ripple: via charge balance}
    \begin{columns}
                ...
                \begin{tikzpicture}
                    ...
                    \begin{groupplot}[group style={group size=1 by 2, xticklabels at = edge bottom}, height=0.4\textheight, width=0.9\textwidth, xmin=-0.1, xmax=1.1, grid,clip = false, ymin = 0, ymax =1.1]
                        ...
                        \nextgroupplot[ylabel = {$u_\mathrm{T}(t)$}, ytick = {0, 0.5, 1}, yticklabels = {0, , $U_1$}]
                            \addplot[signalblue, thick] coordinates {(-0.1,1) (0,1) (0,0) (\D,0) (\D,1) (\Ts,1) (\Ts,0) (\Ts+0.1,0)};
                        ...
                        \nextgroupplot[ylabel = {$i_\mathrm{T}(t)$}, xlabel={$t/T_\mathrm{s}$}, ytick = {0, 0.5, 1}, yticklabels = {0, , $\nicefrac{\overline{i}_1}{D}$}]
                            % Current signal
                            \addplot[signalred, thick] coordinates {(-0.1,0) (0,0) (0,1) (\D,1) (\D,0) (\Ts,0) (\Ts,1) (\Ts+0.1,1)};
                            \addplot[signalred, thick, dashed] coordinates {(-0.1,\D) (1.1,\D)};
                ...
                \begin{tikzpicture}
                    ...
                    \begin{groupplot}[group style={group size=1 by 2, xticklabels at = edge bottom}, height=0.4\textheight, width=0.9\textwidth, xmin=-0.1, xmax=1.1, grid,clip = false, ymin = 0, ymax =1.1]
                        ...
                        \nextgroupplot[ylabel = {$i_\mathrm{T}(t)$}, xlabel={$t/T_\mathrm{s}$}, ytick = {0, 0.5, 1}, yticklabels = {0, , $\overline{i}_1$}]
                            % Current signal
                            \addplot[signalred, thick] coordinates {(-0.1,0) (0,0) (0,1) (\D,1) (\D,0) (\Ts,0) (\Ts,1) (\Ts+0.1,1)};
                            \addplot[signalred, thick, dashed] coordinates {(-0.1,1) (1.1,1)};
            ...
            \begin{figure}
                \begin{tikzpicture}[pin distance=0.2cm]
                    \begin{axis}[
                        ...
                        \addplot[signalblue, domain=0:1, samples=10] {x}node[left,pos=0.4, anchor = east, inner sep = 1pt, fill = white, xshift=-0.3cm]{step-down};
                        \addplot[signalblue, domain=0:1, samples=10] {1-x} node[right,pos=0.6, anchor = west, inner sep = 1pt, fill = white, xshift=0.3cm]{step-up};
                        \addplot[signalblue, domain=0:1, samples=25] {(1-x)*x} node[below,pos=0.5, anchor = north, inner sep = 1pt, fill = white, yshift=-0.2cm]{inv. buck-boost};
                    \end{axis}
                \end{tikzpicture}
...
\begin{frame}[b]
    ...
    \end{itemize}
        \onslide<2->{
        To answer this, we consider the following assumptions:}
        \begin{itemize}
            ...
            \begin{figure}
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[signalblue, domain=0:1, samples=25] {2*x-1};
                    \end{axis}
                \end{tikzpicture}
