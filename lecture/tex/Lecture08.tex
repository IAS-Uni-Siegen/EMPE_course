...
\begin{frame}[c]
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Home_appliance.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Smartphone_charger.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Induction_plate.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/LED_light_bulb.jpg}
...
\begin{frame}[c]
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/UPS.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Welding.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Robot.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Conveyor.jpg}
...
\begin{frame}[c]
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/sky-farm-windmill.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/PV_field.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Battery_storage.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/HVDC.jpg}
...
\begin{frame}[c]
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/ICE.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Drive.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Scooter.jpg}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{fig/PE_fig/lec01/Electric_ship.jpg}
...
\begin{frame}[c]
	...
	\begin{figure}
		\centering
		\includegraphics[height=0.7\textheight]{fig/PE_fig/lec01/Power_Classes_Examples.pdf}
...
\begin{frame}
	...
	\begin{figure}
		\begin{tikzpicture}[auto, node distance = 1.5cm and 2cm]
			...
			\onslide<3->{\node[overlay, bubble, right = of input, minimum height = 4em, pin=80:Change of stored energy $ \frac{}{t}E_\mathrm{i}(t)$] {\large Power converter};}
			\begin{scope}[on background layer]
	...
	\begin{equation}
		\onslide<1->{P_\mathrm{in}(t)} \onslide<2->{= P_\mathrm{l}(t)}  \onslide<3->{+ \frac{}{t}E_\mathrm{i}(t)} \onslide<4->{+ P_\mathrm{out}(t)}
	\end{equation}
